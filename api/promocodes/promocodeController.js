...
exports.createPromocode = async (req, res, next)=>{
    try
    {
        ...
        res.status(200).json({success : true, data : {...req.body}, message : "Promo Code inserted successfully"});
    }
    catch(err)
    {
        next(err);
...
exports.editPromocode = async (req, res, next)=>{
    try
    {
        ...
        res.status(200).json({success : true, data : {...req.body}, message : "Promo code updated successfully"});
    }
    catch(err)
    {
        next(err);
